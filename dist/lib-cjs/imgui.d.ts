...
export declare class ImDrawList {
    ...
    PopTextureID(): void;
    GetClipRectMin(out?: Bind.interface_ImVec2): typeof out;
    GetClipRectMax(out?: Bind.interface_ImVec2): typeof out;
...
export declare function GetContentRegionMax(out?: Bind.interface_ImVec2): typeof out;
export declare function GetContentRegionAvail(out?: Bind.interface_ImVec2): typeof out;
export declare function GetWindowContentRegionMin(out?: Bind.interface_ImVec2): typeof out;
export declare function GetWindowContentRegionMax(out?: Bind.interface_ImVec2): typeof out;
export declare function GetWindowContentRegionWidth(): number;
export declare function GetWindowDrawList(): ImDrawList;
export declare function GetWindowPos(out?: Bind.interface_ImVec2): typeof out;
export declare function GetWindowSize(out?: Bind.interface_ImVec2): typeof out;
...
export declare function GetFontTexUvWhitePixel(out?: Bind.interface_ImVec2): typeof out;
...
export declare function GetCursorPos(out?: Bind.interface_ImVec2): typeof out;
...
export declare function GetCursorStartPos(out?: Bind.interface_ImVec2): typeof out;
export declare function GetCursorScreenPos(out?: Bind.interface_ImVec2): typeof out;
...
export declare function GetItemRectMin(out?: Bind.interface_ImVec2): typeof out;
export declare function GetItemRectMax(out?: Bind.interface_ImVec2): typeof out;
export declare function GetItemRectSize(out?: Bind.interface_ImVec2): typeof out;
...
export declare function CalcTextSize(text: string, text_end?: number | null, hide_text_after_double_hash?: boolean, wrap_width?: number, out?: Bind.interface_ImVec2): typeof out;
...
export declare function ColorConvertU32ToFloat4(in_: Bind.ImU32, out?: Bind.interface_ImVec4): typeof out;
...
export declare function GetMousePos(out?: Bind.interface_ImVec2): typeof out;
export declare function GetMousePosOnOpeningCurrentPopup(out?: Bind.interface_ImVec2): typeof out;
export declare function GetMouseDragDelta(button?: number, lock_threshold?: number, out?: Bind.interface_ImVec2): typeof out;
